...
const API = import.meta.env.VITE_API_BASE_URL || "https://sih-ps-01.onrender.com";
...
function WeatherPage() {
  return <Page title="🌧️ Weather Risk" description="Weather-linked risk indicators.">
    <div className="stats"><Card title="Rainfall" value="182 mm" /><Card title="Soil Moisture" value="81%" /><Card title="Forecast" value="HEAVY" danger /></div>
    <div className="notice">Demo weather values are simulated. Connect an authorized weather provider for live data.</div>
  </Page>;
}
